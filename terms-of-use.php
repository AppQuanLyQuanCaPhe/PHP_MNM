  ...
  <body class="demo-1">
    <div class="ip-container" id="ip-container">
      ...
      <div class="ip-main">
        ...
        <!-- End Header Cake --><!-- Start Terms Of Use -->
              ...
              <div class="row">
                <div class="col-sm-8">
                  ...
                  <p class="important-text">
                    Dragée lollipop cheesecake cupcake toffee muffin jelly fruitcake cookie. Tootsie roll marshmallow chocolate bar. Jelly-o bear claw croissant donut pie. Apple pie jujubes carrot cake candy jelly cookie dessert caramels fruitcake.
                  </p>
                  <div class="page-header">
                    <h3>
