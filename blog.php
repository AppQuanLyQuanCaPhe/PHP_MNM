              ...
              <div class="top-header">
                <div class="container">
                  <div class="navbar-header visible-xs">
                    <button class="navbar-toggle toggle-cake show-menu"><span class="sr-only">Toggle Navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a class="navbar-brand navbar-cake" href="#"><img alt="Cake-White" src="assets/images/logo-100.png"></a>
                  </div>
                  <nav>
                    <ul class="header-nav hidden-xs">
                      ...
                      <li class="pad-top-0i">
                        <img alt="Cake-White" src="assets/images/logo-150.png">
                      </li>
                      <li>
                ...
                <div class="col-sm-8 overflow-xs">
                  <div class="wrap-blog-content">
                    ...
                    <div class="right-hand-content-blog">
                      <img alt="Cakes-co" class="img-100" src="assets/images/cakes-co.jpg">
                  ...
                  <div class="wrap-blog-content">
                    ...
                    <div class="right-hand-content-blog">
                      <img alt="Cakes-co1" class="img-100" src="assets/images/cakes-co1.jpg">
                      <article class="content-blog-bottom">
                        <div class="row">
                          <div class="col-sm-8">
                            <h4>
                  ...
                  <div class="wrap-blog-content">
                    ...
                    <div class="right-hand-content-blog">
                      <img alt="Cakes-co2" class="img-100" src="assets/images/cakes-co2.jpg">
                      <article class="content-blog-bottom">
                        <div class="row">
                          <div class="col-sm-8">
                            <h4>
